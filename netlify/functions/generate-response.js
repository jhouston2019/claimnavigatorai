...
`;
  ...
  const sys = "You are Claim Command Pro. Draft clear, assertive claim communications. Keep output HTML-ready. ALWAYS start your response with the claim information header provided.";
