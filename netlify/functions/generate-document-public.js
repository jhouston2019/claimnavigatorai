  ...
  try {
    ...
    const ai = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `You are Claim Command Pro, an expert insurance document generator. Create professional, legally sound insurance documents with the following requirements:
