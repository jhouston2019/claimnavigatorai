...
exports.handler = async (event) => {
  try {
    ...
    try {
      ...
      const response = await fetch(`${process.env.SITE_URL || process.env.URL || 'https://Claim Command Pro.com'}/assets/data/github-documents.json`);
      if (response.ok) {
      ...
      if (fs.existsSync(englishDir)) {
        ...
        documents = files.map(file => {
          ...
          return {
            ...
            templatePath: `https://raw.githubusercontent.com/jhouston2019/Claim Command Pro/main/docs/en/${file}`,
            samplePath: sampleExists ? `https://raw.githubusercontent.com/jhouston2019/Claim Command Pro/main/docs/en/${sampleFile}` : null
          };
        });
      }
    } else if (lang === 'es') {
      ...
      if (fs.existsSync(spanishDir)) {
        ...
        documents = files.map(file => {
          ...
          return {
            ...
            templatePath: `https://raw.githubusercontent.com/jhouston2019/Claim Command Pro/main/docs/es/${file}`,
            samplePath: sampleExists ? `https://raw.githubusercontent.com/jhouston2019/Claim Command Pro/main/docs/es/${sampleFile}` : null
          };
        });
      }
    }
