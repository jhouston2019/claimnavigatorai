...
async function protectPDF(pdfBuffer, userEmail) {
  try {
    ...
    for (let i = 0; i < pages.length; i++) {
      ...
      page.drawText(`Generated by Claim Command Pro for ${userEmail}`, {
 ...
 */
async function generateSecurePDF(content, userEmail, title = 'Claim Command Pro Document') {
  ...
  doc.fontSize(8)
     ...
     .text(`Generated by Claim Command Pro for ${userEmail}`, { 
       align: 'center',
       opacity: 0.6
     });
...
async function addPasswordProtection(pdfBuffer, userPassword, ownerPassword) {
  ...
  try {
    ...
    try {
      ...
      pdfDoc.setTitle('Claim Command Pro Document');
      pdfDoc.setAuthor('Claim Command Pro');
      pdfDoc.setSubject('Insurance Claim Document');
      pdfDoc.setKeywords(['claim', 'insurance', 'document']);
      pdfDoc.setProducer('Claim Command Pro');
      pdfDoc.setCreator('Claim Command Pro');
