  ...
  if (process.env.SENDGRID_API_KEY) {
    try {
      ...
      const msg = {
        ...
        cc: cc,
        bcc: bcc,
        from: process.env.FNOL_EMAIL_FROM || process.env.SENDGRID_FROM_EMAIL || 'noreply@Claim Command Pro.com',
        subject: subject,
        text: body,
        html: body.replace(/\n/g, '<br>'),
...
async function generateFNOLPDF(fnolPayload) {
  ...
  // Footer
  const footerY = 50;
  page.drawText('Generated by Claim Command Pro', {
    x: margin,
    y: footerY,
    size: 8,
    font: font,
...
This FNOL has been generated and submitted via Claim Command Pro.
