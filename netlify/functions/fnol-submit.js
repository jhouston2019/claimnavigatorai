  ...
  if (process.env.SENDGRID_API_KEY) {
    try {
      ...
      const msg = {
        ...
        cc: cc,
        bcc: bcc,
        from: process.env.FNOL_EMAIL_FROM || process.env.SENDGRID_FROM_EMAIL || 'noreply@claimnavigatorai.com',
        subject: subject,
        text: body,
        html: body.replace(/\n/g, '<br>'),
...
This FNOL has been generated and submitted via ClaimNavigatorAI.
