...
function getSystemPrompt(documentInfo) {
  ...
  const basePrompt = "You are ClaimNavigatorAI, an expert insurance documentation assistant. Generate professional, ready-to-submit insurance claim documents.";
...
function applyWatermark(content, formData) {
  const watermark = `
    <div style="text-align: center; color: #666; font-size: 10px; margin-top: 20px; border-top: 1px solid #eee; padding-top: 10px;">
      Generated by ClaimNavigatorAI - Professional Insurance Claim Documentation
    </div>
  `;
