...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const expertEmail = process.env.EXPERT_EMAIL || 'experts@ClaimCommandPro.ai';
    const fromEmail = process.env.FROM_EMAIL || 'no-reply@ClaimCommandPro.ai';
    const fromName = process.env.FROM_NAME || 'Claim Command Pro';
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p style="color: #6b7280; font-size: 0.875rem;">
            This request was submitted through Claim Command Pro Expert Opinion Request form.
          </p>
        </div>
      `,
      text: `
