/**
 * Generate full monitoring data for all tables
 * Populates system_errors, api_usage_logs, ai_cost_tracking, rate_limit_logs, system_events
 */
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Insert all data
    const [errorsResult, usageResult, costResult, rateLimitResult, eventsResult] = await Promise.all([
      supabase.from('system_errors').insert(errors),
