...
2. Select your site: `Claim Command Pro`
...
```powershell
Invoke-RestMethod -Uri "https://Claim Command Pro.com/.netlify/functions/populate-documents-bilingual" -Method POST -ContentType "application/json" -Body "{}"
```
