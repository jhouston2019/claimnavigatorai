...
exports.handler = async (event, context) => {
  try {
            ...
            .insert([
              {
                ...
                label: label,
                language: 'en',
                template_path: `en_${file}`, // New flat structure
                sample_path: null
              }
            ]);
            ...
            .insert([
              {
                ...
                label: label,
                language: 'es',
                template_path: `es_${file}`, // New flat structure
                sample_path: null
              }
            ]);
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        message: `Documents table updated: ${totalUpdated} documents, ${totalFailed} failed`,
        results,
        summary: {
          totalUpdated,
          totalFailed,
          ...
          structure: 'Flat structure with en_/es_ prefixes'
        }
      })
    };
