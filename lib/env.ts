export const env = (() => {
  ...
  return {
    ...
    // Stripe pricing IDs
    STRIPE_PRICE_CLAIM_COMMAND_PRO_DIY_TOOLKIT: process.env.STRIPE_PRICE_CLAIM_COMMAND_PRO_DIY_TOOLKIT,
    STRIPE_PRICE_CLAIM_COMMAND_PRO_APPEAL_BUILDER: process.env.STRIPE_PRICE_CLAIM_COMMAND_PRO_APPEAL_BUILDER,
