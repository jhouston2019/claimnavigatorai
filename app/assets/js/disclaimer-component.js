...
(function() {
  ...
  const DISCLAIMER_TEXT = `
    ...
    Claim Command Pro AI provides informational tools and document assistance only.
  ...
  const DISCLAIMER_COMPACT = `
    <strong>Disclaimer:</strong> ClaimCommandProAI provides documentation tools only, not legal advice or professional services.
  ...
  function wrapExportWithDisclaimer(buttonId, originalHandler) {
    ...
    newButton.addEventListener('click', function(e) {
      ...
      const acknowledged = confirm(
        'Disclaimer: ClaimCommandProAI provides documentation tools only, not legal advice or professional services. ' +
        'You are responsible for all claim decisions. Consult licensed professionals for legal or coverage advice.\n\n' +
