...
export function formatClaimOutput({
  ...
  const metadata = {
    ...
    generatedBy: 'Claim Command Pro AI',
    version: '1.0'
  };
  ...
  return `
    <div class="claim-output-footer">
      ...
      <div class="claim-output-generator">
        Generated by Claim Command Pro on ${new Date(metadata.timestamp).toLocaleDateString('en-US')}
      </div>
...
function formatAsPlainText(content, outputType, title, claimInfo, metadata) {
  ...
  // Footer
  lines.push('Generated by Claim Command Pro');
