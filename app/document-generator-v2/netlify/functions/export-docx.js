...
function createDOCXDocument(content, userData, docTitle) {
  ...
  const children = [
    ...
    new Paragraph({
      children: [
        new TextRun({
          text: "Claim Command Pro — Confidential Claim File",
          bold: true,
          size: 18,
          color: "1e40af"
        })
    ...
    new Paragraph({
      children: [
        new TextRun({
          text: "© Claim Command Pro — Confidential · Generated by Claim Command Pro",
          italic: true,
          size: 18,
          color: "999999"
        })
