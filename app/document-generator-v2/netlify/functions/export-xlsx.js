...
function createXLSXWorkbook(content, userData, docTitle, fields) {
  ...
  const headerInfo = userData && userData.userName ? 
    `Claim Command Pro — Confidential Claim File | Policyholder: ${userData.userName} | Policy #: ${userData.policyNumber || '[Policy Number]'} | Claim #: ${userData.claimNumber || '[Claim Number]'}` :
  ...
  // Add footer
  worksheet.addRow([]);
  worksheet.addRow(['© Claim Command Pro — Confidential · Generated by Claim Command Pro']);
