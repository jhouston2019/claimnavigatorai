...
1. Open the file directly in your browser:
   ```
   file:///D:/Projects - Master/Priority 1/Claim Command Pro/app/resource-center/document-generator.html
   ```

#### **Option B: Use the Test File**
1. Open the standalone test file:
   ```
   file:///D:/Projects - Master/Priority 1/Claim Command Pro/test-document-generator-standalone.html
   ```
