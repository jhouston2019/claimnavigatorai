...
This directory contains all images and photos for the Claim Command Pro website.
...
```html
<!-- Hero image -->
<img src="assets/images/heroes/claim-command-pro-hero.jpg" alt="Claim Command Pro">
